<div id="stats" style="display: block;">
    ...
    <div class="stat">
        ...
        <div class="progress-bar">
            <div class="progress" id="easy-progress" style="width: 5.28846%;"></div>
        </div>
    </div>
    ...
    <div class="stat">
        ...
        <div class="progress-bar">
            <div class="progress" id="medium-progress" style="width: 1.31429%;"></div>
        </div>
    </div>
    ...
    <div class="stat">
        ...
        <div class="progress-bar">
            <div class="progress" id="hard-progress" style="width: 0.788436%;"></div>
        </div>
    </div>
